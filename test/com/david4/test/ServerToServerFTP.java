...
//        }
        ...
        username1 = "batch";
        password1 = "batch";
        file1 = "/home/batch/FH1103097000705000002001A00705000001";
        server2 = "10.1.12.20:21";
        parts = server2.split(":");
        if (parts.length == 2) {
            server2=parts[0];
        ...
        username2 = "weblogic";
        password2 = "weblogic";
        file2 = "/home/weblogic/FH1103097000705000002001A00705000001";
...
__main:
        try
        {
            ...
            System.out.println("ftp1.printWorkingDirectory()="+ftp1.printWorkingDirectory());
            System.out.println("ftp2.printWorkingDirectory()="+ftp2.printWorkingDirectory());
